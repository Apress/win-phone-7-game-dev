...
namespace VaporTrailTS
{
    class SmokeParticleObject : GameFramework.MatrixParticleObjectBase
    {
        ...
        private VaporTrailTSGame _game;
        ...
        public SmokeParticleObject(VaporTrailTSGame game, Texture2D texture, Vector3 position, Vector3 scale)
            : base(game)
        {
            _game = game;
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            ApplyTransformation(Matrix.CreateBillboard(Position, Game.Camera.Transformation.Translation, Game.Camera.Transformation.Up, Game.Camera.Transformation.Forward));
            // Rotate and scale
