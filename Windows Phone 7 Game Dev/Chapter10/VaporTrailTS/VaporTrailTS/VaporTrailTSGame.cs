...
namespace VaporTrailTS
{
    ...
    /// </summary>
    public class VaporTrailTSGame : GameFramework.GameHost
    {
        ...
        protected override void Initialize()
        {
            ...
            Matrix view = Matrix.CreateLookAt(new Vector3(0, 25, 25), new Vector3(0, 0, 0), new Vector3(0, 1, 0));
        ...
        protected override void GameDeactivated()
        {
            ...
            PhoneApplicationService.Current.State.Add("_cameraMode", _cameraMode);
        }
        ...
        protected override void GameActivated()
        {
            ...
            _plane = (PaperPlaneObject)GetObjectByTag("_plane");

            // Restore game variables
            _cameraMode = (int)PhoneApplicationService.Current.State["_cameraMode"];
            SetCameraMode();
        }
        ...
        {
            GraphicsDevice.Clear(new Color(79, 128, 169));
