...
namespace SpritesAndSolids
{
    class CubeObject : GameFramework.MatrixObjectBase
    {
        ...
        public CubeObject(SpritesAndSolidsGame game, Vector3 position, Texture2D texture, Vector3 rotationSpeed)
            : base(game)
        {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            AngleX += MathHelper.ToRadians(_rotationSpeed.X);
            AngleY += MathHelper.ToRadians(_rotationSpeed.Y);
            AngleZ += MathHelper.ToRadians(_rotationSpeed.Z);
