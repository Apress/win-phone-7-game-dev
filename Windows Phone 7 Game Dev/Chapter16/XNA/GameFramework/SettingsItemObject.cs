...
namespace GameFramework
{
    public class SettingsItemObject : TextObject
    {
        ...
        public SettingsItemObject(GameHost game, Vector2 position, SpriteFont font, float scale, SettingsManager settingsManager, string name, string title, string defaultValue, string[] values)
            : base(game)
        {
