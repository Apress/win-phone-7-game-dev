...
namespace VaporTrail
{
    ...
    /// </summary>
    public class VaporTrailGame : GameFramework.GameHost
    {
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (lastMouseState.LeftButton == ButtonState.Released && thisMouseState.LeftButton == ButtonState.Pressed)
            {
