...
namespace SLGameFramework
{
    public static class GameHelper
    {
        ...
        /// <summary>
        /// Returns a random double between zero and the provided value.
        /// </summary>
        /// <param name="maxValue">The maximum permitted value</param>
        /// <returns></returns>
        public static double RandomNext(double maxValue)
        {
            // Create the Random object is not already available
            if (_rand == null) _rand = new Random();
        ...
        /// <summary>
        /// Returns a random double between the two provided values.
        /// </summary>
        /// <param name="minValue">The minimum permitted value.</param>
        /// <param name="maxValue">The maximum permitted value.</param>
        /// <returns></returns>
        public static double RandomNext(double minValue, double maxValue)
        {
            // Create the Random object is not already available
            if (_rand == null) _rand = new Random();
