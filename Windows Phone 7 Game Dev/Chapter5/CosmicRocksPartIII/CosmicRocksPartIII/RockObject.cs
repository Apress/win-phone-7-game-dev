...
namespace CosmicRocksPartIII
{
    internal class RockObject : GameFramework.SpriteObject
    {
        ...
        internal RockObject(CosmicRocksPartIIIGame game, Texture2D texture, int generation, float size, float speed)
            : base(game, Vector2.Zero, texture)
        {
            ...
            PositionY = GameHelper.RandomNext(0, _game.Window.ClientBounds.Height);
        ...
        internal void DamageRock()
        {
            ...
            // Play a sound effect
            _game.SoundEffects["RockExplosion"].Play(1.0f, GameHelper.RandomNext(-0.3f, 0.3f), 0.0f);
