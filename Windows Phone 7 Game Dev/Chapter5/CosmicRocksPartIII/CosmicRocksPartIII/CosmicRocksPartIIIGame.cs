...
namespace CosmicRocksPartIII
{
    ...
    /// </summary>
    public class CosmicRocksPartIIIGame : GameFramework.GameHost
    {
        ...
        private void ResetGame()
        {
            ...
            // Add the player ship
            _playerShip = new SpaceshipObject(this, Textures["Spaceship"], new Vector2(Window.ClientBounds.Width / 2, Window.ClientBounds.Height / 2));
