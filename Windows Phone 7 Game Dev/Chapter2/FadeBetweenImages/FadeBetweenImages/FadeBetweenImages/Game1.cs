...
namespace FadeBetweenImages
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        protected override void LoadContent()
        {
            ...
            _backgroundTextures[0] = Content.Load<Texture2D>("Beach");
            _backgroundTextures[1] = Content.Load<Texture2D>("Sunset");
            _backgroundTextures[2] = Content.Load<Texture2D>("Trees");
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            _spriteBatch.Draw(_backgroundTextures[_backgroundImageIndex], this.Window.ClientBounds, Color.White);
            // Draw the fader
            _spriteBatch.Draw(_backgroundTextures[_faderImageIndex], this.Window.ClientBounds, new Color(255, 255, 255, _faderAlpha));
            // End the spriteBatch
            _spriteBatch.End();
