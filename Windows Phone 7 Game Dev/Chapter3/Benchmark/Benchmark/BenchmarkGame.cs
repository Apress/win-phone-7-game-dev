...
namespace Benchmark
{
    ...
    public class BenchmarkGame : GameFramework.GameHost
    {
        ...
        protected override void LoadContent()
        {
            ...
            // Load a font to use for the benchmark display
            ...
            GameObjects.Add(new BenchmarkObject(this, Fonts["Kootenay"], new Vector2(0, 100), Color.White));
        }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //// Version 2: draw all sprites sorted by texture
            //_spriteBatch.Begin(SpriteSortMode.Texture, BlendState.AlphaBlend);
            //DrawSprites(gameTime, _spriteBatch);
            //DrawText(gameTime, _spriteBatch);
            //_spriteBatch.End();

            //// Version 3: draw all sprites one texture at a time
            //_spriteBatch.Begin();
        ...
        private void AddPlanets_Interleaved()
        {
            ...
            {
                // Add a planet...
                planetPosition = new Vector2(GameHelper.RandomNext(Window.ClientBounds.Width), GameHelper.RandomNext(Window.ClientBounds.Bottom));
