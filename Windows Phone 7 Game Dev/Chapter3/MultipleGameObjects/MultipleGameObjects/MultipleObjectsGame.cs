...
namespace MultipleGameObjects
{
    ...
    public class MultipleObjectsGame : GameFramework.GameHost
    {
        ...
        private void ResetGame()
        {
            ...
            // Add some text
            message = new TextObject(this, Fonts["Kootenay"], new Vector2(240, 400), "Windows Phone 7 Game Development", TextObject.TextAlignment.Center, TextObject.TextAlignment.Center);
