...
namespace GameFramework
{
    ...
    public class MatrixSkyboxObject : MatrixObjectBase
    {
        ...
        /// <summary>
        /// A dummy property to force object serialization
        /// </summary>
        [DataMember]
        public bool _dummyProperty { get; set; }


        /// <summary>
        /// Build (if needed) and return the vertices for the skybox
        /// </summary>
        private VertexPositionColorTexture[] Vertices
        {
            get
            {
                // Have we already built the cube vertex array?
                if (_vertices == null)
                {
        ...
        /// <summary>
        /// Build (if needed) and return the vertex buffer for the skybox
        /// </summary>
        private VertexBuffer VertexBuffer
        {
            get
            {
                // Have we already build the vertex buffer?
                if (_vertexBuffer == null)
                {
                    // No, so create it now
                    _vertexBuffer = new VertexBuffer(Game.GraphicsDevice, typeof(VertexPositionColorTexture), Vertices.Length, BufferUsage.WriteOnly);
