...
namespace AccelerometerDemo
{
    internal class BallObject : SpriteObject
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (BoundingBox.Right >= Game.Window.ClientBounds.Right && Velocity.X > 0)
            {
                PositionX = Game.Window.ClientBounds.Right - SpriteTexture.Width / 2;
            ...
            if (BoundingBox.Bottom >= Game.Window.ClientBounds.Bottom && Velocity.Y > 0)
            {
                PositionY = Game.Window.ClientBounds.Bottom - SpriteTexture.Height / 2;
